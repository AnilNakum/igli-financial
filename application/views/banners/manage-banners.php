            ...
            <div class="col-lg-5 col-md-4 col-sm-4">
                <h2><?php echo $page_title; ?>
                    <a href="javascript:void(0);"><img src="<?php echo ASSETS_PATH; ?>images/question.jpg"
                            ...
                            title="You can manage & add/update Banner." /></a>
                </h2>
            </div>
            <div class="col-lg-7 col-md-8 col-sm-8">
                <a href="javascript:void(0);" class="btn btn-round l-blue pull-right open_my_form" data-control="banner"
                    data-method="add">Add New Banner</a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <?php if (count((array) $Banners) == 0) {?>
                    <div class="body text-center manage-list">
                        <div class="institute-box">
                            <img src="<?php echo ASSETS_PATH; ?>images/finder.png">
                            <h3>No records for Banner right now <br /> Please add new</h3>
                            <a href="javascript:void(0);" class="open_my_form" data-control="banner"
                                        ...
                                        <div class="manage-rightside">
                                            <div class="form-group">
                                                <div class="manage-searchbar">
                                                    ...
                                                    <input class="form-control" id="search" placeholder="Search Banner"
                                                        type="search">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="setup-content">
                                <div class="manage-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover common_datatable" data-control="banner"
                                            data-method="manage">
                                            <thead>
                                                <tr>
                                                    <th>Banner Image</th>
