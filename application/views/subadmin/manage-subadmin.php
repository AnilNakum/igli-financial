            ...
            <div class="col-lg-5 col-md-4 col-sm-4">
                <h2><?php echo $page_title; ?>
                    <a href="javascript:void(0);"><img src="<?php echo ASSETS_PATH; ?>images/question.jpg"
                            ...
                            title="You can manage & add/update Sub Admins." /></a>
                </h2>
            </div>
            <div class="col-lg-7 col-md-8 col-sm-8">
                <a href="javascript:void(0);" class="btn btn-round l-blue pull-right open_my_form"
                    data-control="subadmin" data-method="add" data-form_type="half">Add New Sub Admin</a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <?php if (count((array) $SubAdmins) == 0) {?>
                    <div class="body text-center manage-list">
                        <div class="institute-box">
                            <img src="<?php echo ASSETS_PATH; ?>images/finder.png">
                            <h3>No records for Sub Admin right now <br /> Please add new</h3>
                            <a href="javascript:void(0);" class="open_my_form" data-control="subadmin" data-method="add"
