...
|
 */
$config['rest_valid_logins'] = ['IGLI-API' => 'API@IGLI'];
...
|
 */
$config['rest_key_name'] = 'X-CI-API-KEY';
...
$config['rest_access_table'] = TBL_API_ACCESS;
...
$config['rest_limits_table'] = TBL_API_LIMITS;
...
$config['lgoin_token_variable'] = "Token";
$config['lgoin_id_variable'] = "User-Id";
