   ...
   Plugin.prototype =
           {
              ...
              initHours: function ()
              {
                 ...
                 for (var i = 0; i < 12; i++)
                 {
                    ...
                    var fill = ((this.currentDate.format(hFormat) == i) ? "#208bd4" : 'transparent');
                 ...
                 if (!this.params.shortTime)
                 {
                    for (var i = 0; i < 12; i++)
                    {
                       ...
                       var fill = ((this.currentDate.format(hFormat) == (i + 12)) ? "#208bd4" : 'transparent');
              ...
              initMinutes: function ()
              {
                 ...
                 for (var i = 0; i < 60; i++)
                 {
                    ...
                    var color = ((this.currentDate.format("m") == i) ? "#208bd4" : 'transparent');
              ...
              createSVGClock: function (isHour)
              {
                 ...
                 if (isHour)
                 {
                    ...
                    var svgHourHand = this.createSVGElement("line", {class: 'hour-hand', x1: 0, y1: 0, x2: 0, y2: hl, stroke: '#208bd4', 'stroke-width': 8});

                    svgGElement.appendChild(svgMinuteHand);
                    svgGElement.appendChild(svgHourHand);
                 } else
                 {
                    var svgMinuteHand = this.createSVGElement("line", {class: 'minute-hand', x1: 0, y1: 0, x2: 0, y2: -150, stroke: '#208bd4', 'stroke-width': 2});
              ...
              _onSelectHour: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    $(parent.find('#h-' + value)).attr('fill', '#208bd4');
              ...
              _onSelectMinute: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    $(parent.find('#m-' + value)).attr('fill', '#208bd4');
