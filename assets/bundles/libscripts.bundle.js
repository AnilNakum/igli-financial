! function (e, t) {
    ...
    var b = function (n) {
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me, p = oe.tokenize = function (e, t) {
            ...
            if (!s) {
                ...
                (s = D(e, (m = o, y = 0 < (v = r).length, _ = 0 < m.length, i = function (e, t, n, i, r) {
                    var o, s, a, l = 0,
                        u = "0",
                        c = e && [],
                        f = [],
    ...
    function I(e, n, i) {
        ...
        }) : N.test(n) ? C.filter(n, e, i) : (n = C.filter(n, e), C.grep(e, function (e) {
                                ...
                                var n = this,
                                    ...
                                    e = function () {
                                        ...
                                        if (!(r < l)) {
                                            ...
                                            t = e && ("object" == typeof e || "function" == typeof e) && e.then, C.isFunction(t) ? a ? t.call(e, u(l, o, F, a), u(l, o, q, a)) : (l++, t.call(e, u(l, o, F, a), u(l, o, q, a), u(l, o, F, o.notifyWith))) : (s !== F && (n = void 0, i = [e]), (a || o.resolveWith)(n, i))
                                        }
                                    },
                                    t = a ? e : function () {
                                        try {
    ...
    }), C.ready.then = W.then, "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? T.setTimeout(C.ready) : (x.addEventListener("DOMContentLoaded", B), T.addEventListener("load", B));
    ...
    fe = x.createDocumentFragment().appendChild(x.createElement("div")), (he = x.createElement("input")).setAttribute("type", "radio"), he.setAttribute("checked", "checked"), he.setAttribute("name", "t"), fe.appendChild(he), m.checkClone = fe.cloneNode(!0).cloneNode(!0).lastChild.checked, fe.innerHTML = "<textarea>x</textarea>", m.noCloneChecked = !!fe.cloneNode(!0).lastChild.defaultValue;
    ...
    C.event = {
        ...
        add: function (t, e, n, i, r) {
            var o, s, a, l, u, c, f, h, d, p, g, m = Q.get(t);
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(ge, r), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                    ...
                    }), u = (e = (e || "").match(P) || [""]).length; u--;) d = g = (a = ye.exec(e[u]) || [])[1], p = (a[2] || "").split(".").sort(), d && (f = C.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {}, c = C.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
        ...
        remove: function (e, t, n, i, r) {
            var o, s, a, l, u, c, f, h, d, p, g, m = Q.hasData(e) && Q.get(e);
            if (m && (l = m.events)) {
    ...
    function Oe(n, i, r, o) {
        ...
        var e, t, s, a, l, u, c = 0,
            ...
            d = i[0],
            p = C.isFunction(d);
        if (p || 1 < f && "string" == typeof d && !m.checkClone && Ce.test(d)) return n.each(function (e) {
            var t = n.eq(e);
        ...
        if (f && (t = (e = pe(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)
                for (u = s[s.length - 1].ownerDocument, C.map(s, Ie), c = 0; c < a; c++) l = s[c], ae.test(l.type || "") && !Q.access(l, "globalEval") && C.contains(u, l) && (l.src ? C._evalUrl && C._evalUrl(l.src) : v(l.textContent.replace(De, ""), u))
        }
        return n
    }
    ...
    function Fe(e, t, n) {
        ...
        return (n = n || Pe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || C.contains(e.ownerDocument, e) || (s = C.style(e, t)), !m.pixelMarginRight() && He.test(s) && je.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function ze(e, t, n) {
        ...
        return He.test(o) ? o : (i = s && (m.boxSizingReliable() || o === e.style[t]), "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = parseFloat(o) || 0) + Ve(e, t, n || (s ? "border" : "content"), i, r) + "px")
    }
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = C.camelCase(t),
                    l = Me.test(t),
                    u = e.style;
                return l || (t = $e(a)), s = C.cssHooks[t] || C.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t] : ("string" === (o = typeof n) && (r = J.exec(n)) && r[1] && (n = ne(e, t, r), o = "number"), void(null != n && n == n && ("number" === o && (n += r && r[3] || (C.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))))
            }
        },
        css: function (e, t, n, i) {
            var r, o, s, a = C.camelCase(t);
            return Me.test(t) || (t = $e(a)), (s = C.cssHooks[t] || C.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Fe(e, t, i)), "normal" === r && t in Be && (r = Be[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), C.each(["height", "width"], function (e, s) {
        C.cssHooks[s] = {
            get: function (e, t, n) {
                if (t) return !Re.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ze(e, s, n) : te(e, We, function () {
                    return ze(e, s, n)
                })
            },
            set: function (e, t, n) {
    ...
    var Xe, Ge, Je, Ze, et = /^(?:toggle|show|hide)$/,
        tt = /queueHooks$/;
    ...
    C.Animation = C.extend(st, {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = C._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = m && m.display) && (u = Q.get(e, "display")), "none" === (c = C.css(e, "display")) && (u ? c = u : (re([e], !0), u = e.style.display || u, c = C.css(e, "display"), re([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === C.css(e, "float") && (l || (h.done(function () {
                        p.display = u
    ...
    C.extend(C.event, {
        trigger: function (e, t, n, i) {
            ...
            if (o = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !pt.test(h + C.event.triggered) && (-1 < h.indexOf(".") && (h = (d = h.split(".")).shift(), d.sort()), l = h.indexOf(":") < 0 && "on" + h, (e = e[C.expando] ? e : new C.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = d.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), c = C.event.special[h] || {}, i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                ...
                for (r = 0;
                    (o = f[r++]) && !e.isPropagationStopped();) e.type = 1 < r ? a : c.bindType || h, (u = (Q.get(o, "events") || {})[e.type] && Q.get(o, "handle")) && u.apply(o, t), (u = l && o[l]) && u.apply && K(o) && (e.result = u.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = h, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(f.pop(), t) || !K(n) || l && C.isFunction(n[h]) && !C.isWindow(n) && ((s = n[l]) && (n[l] = null), n[C.event.triggered = h](), C.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    Ot.href = gt.href, C.extend({
        ...
        ajax: function (e, t) {
            ...
            if (_.promise(E), m.url = ((e || m.url || gt.href) + "").replace(At, gt.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(P) || [""], null == m.crossDomain) {
                i = x.createElement("a");
                try {
    ...
    m.cors = !!Ft && "withCredentials" in Ft, m.ajax = Ft = !!Ft, C.ajaxTransport(function (r) {
        var o, s;
        if (m.cors || Ft && !r.crossDomain) return {
            send: function (e, t) {
                var n, i = r.xhr();
    ...
    C.ajaxSetup({
    ...
    }), m.createHTMLDocument = ((qt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === qt.childNodes.length), C.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((i = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href, t.head.appendChild(i)) : t = x), o = !n && [], (r = A.exec(e)) ? [t.createElement(r[1])] : (r = pe([e], t, o), o && o.length && C(o).remove(), C.merge([], r.childNodes)));
        var i, r, o
        ...
        setOffset: function (e, t, n) {
            var i, r, o, s, a, l, u = C.css(e, "position"),
                c = C(e),
                f = {};
            "static" === u && (e.style.position = "relative"), a = c.offset(), o = C.css(e, "top"), l = C.css(e, "left"), r = ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? (s = (i = c.position()).top, i.left) : (s = parseFloat(o) || 0, parseFloat(l) || 0), C.isFunction(t) && (t = t.call(e, n, C.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + r), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, C.fn.extend({
        offset: function (t) {
        ...
        position: function () {
            if (this[0]) {
                ...
                return "fixed" === C.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), D(e[0], "html") || (i = e.offset()), i = {
    ...
    }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = D, "function" == typeof define && define.amd && define("jquery", [], function () {
        return C
    });
    var Wt = T.jQuery,
        Bt = T.$;
...
function (e, t) {
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        var s, a, l, u, c, f, h, d, p, g, m, v, y, _, b = void 0 !== o ? o : t.gpuAcceleration,
                            ...
                            A = void 0,
                            N = void 0;
                        if (N = "bottom" === C ? "HTML" === w.nodeName ? -w.clientHeight + x.bottom : -E.height + x.bottom : x.top, A = "right" === S ? "HTML" === w.nodeName ? -w.clientWidth + x.right : -E.width + x.right : x.left, b && D) T[D] = "translate3d(" + A + "px, " + N + "px, 0)", T[C] = 0, T[S] = 0, T.willChange = "transform";
                        else {
                            var I = "bottom" === C ? -1 : 1,
                                k = "right" === S ? -1 : 1;
    ...
    var Et = "dropdown",
        ...
        Yt = function () {
            ...
            return e.toggle = function () {
                if (!this._element.disabled && !p(this._element).hasClass(Nt)) {
                    ...
                    if (u._clearMenus(), !t) {
                        ...
                        if (p(e).trigger(i), !i.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === p(e).closest(Rt).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(It), p(e).toggleClass(It).trigger(p.Event(At.SHOWN, n))
                        }
                    }
                }
            }, e.show = function () {
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(qt).length)) : Dt.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(Nt))) {
    ...
    p(document).on(At.KEYDOWN_DATA_API, Pt, Yt._dataApiKeydownHandler).on(At.KEYDOWN_DATA_API, qt, Yt._dataApiKeydownHandler).on(At.CLICK_DATA_API + " " + At.KEYUP_DATA_API, Yt._clearMenus).on(At.CLICK_DATA_API, Pt, function (e) {
        ...
        Un = function () {
            ...
            return e.enable = function () {
                ...
                if (p(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (p(n).removeClass(Pn), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Wn] = !1, this._activeTrigger[Mn] = !1, this._activeTrigger[Rn] = !1, p(this.tip).hasClass(Hn)) {
                ...
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusin" === e.type ? Mn : Rn] = !0), p(t.getTipElement()).hasClass(Pn) || t._hoverState === On ? t._hoverState = On : (clearTimeout(t._timeout), t._hoverState = On, t.config.delay && t.config.delay.show ? t._timeout = setTimeout(function () {
                    t._hoverState === On && t.show()
                }, t.config.delay.show) : t.show())
            }, e._leave = function (e, t) {
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? Mn : Rn] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Ln, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function () {
    ...
    var ri = "scrollspy",
        ...
        Ti = function () {
            ...
            return e.refresh = function () {
                ...
                n.hasClass(fi) ? (n.closest(yi).find(bi).addClass(hi), n.addClass(hi)) : (n.addClass(hi), n.parents(pi).prev(gi + ", " + vi).addClass(hi), n.parents(pi).prev(mi).children(gi).addClass(hi)), p(this._scrollElement).trigger(ci.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function () {
    ...
    }), p.fn.tab = Mi._jQueryInterface, p.fn.tab.Constructor = Mi, p.fn.tab.noConflict = function () {
    ...
    p.fn[Wi] = Zi._jQueryInterface, p.fn[Wi].Constructor = Zi, p.fn[Wi].noConflict = function () {
        ...
        }(), e.Util = g, e.Alert = m, e.Button = k, e.Carousel = ae, e.Collapse = Te, e.Dropdown = Yt, e.Modal = mn, e.Popover = ii, e.Scrollspy = Ti, e.Tab = Mi, e.Toast = Zi, e.Tooltip = Un, Object.defineProperty(e, "__esModule", {
            value: !0
        })
});